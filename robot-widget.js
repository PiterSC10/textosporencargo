...
w.innerHTML=`<div class="yr-stage"><span class="yr-aura"></span><img class="yr-dog" src="${A.idle}" alt="YDG-01 perro robot chino fotorrealista"><div class="yr-head"><i></i><b>YDG-01</b><span class="yr-state">ONLINE</span></div><button class="yr-close" type="button" aria-label="Cerrar YDG-01">×</button><span class="yr-scan"></span><span class="yr-beam"></span><div class="yr-message"><b>YDG-01</b><span>HOLA 👋</span></div><div class="yr-guide"><span>1× HOLA</span><span>2× SALTO</span><span>3× RUN</span></div></div>`;
